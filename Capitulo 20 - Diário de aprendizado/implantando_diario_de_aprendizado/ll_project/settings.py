"""
Configurações do Django para o projeto ll_project.

Gerado por 'django-admin startproject' usando Django 4.1b1.
...
# Consulte https://docs.djangoproject.com/en/dev/howto/deployment/checklist/
...
# Configurações de plataforma.sh.
